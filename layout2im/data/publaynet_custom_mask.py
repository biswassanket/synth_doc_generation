...
class PublaynetSceneGraphDataset(Dataset):
...
def get_dataloader(batch_size=10, COCO_DIR='/home/sanket/Documents/PubLayNet/', instance_whitelist=None, stuff_whitelist=None, coco_include_other=False):
    coco_train_image_dir = os.path.join(COCO_DIR, 'publaynet/train')
    coco_val_image_dir = os.path.join(COCO_DIR, 'publaynet/val')
    coco_train_instances_json = os.path.join(COCO_DIR, 'publaynet/train.json')
    # coco_train_stuff_json = os.path.join(COCO_DIR, 'annotations/stuff_train2017.json')
    coco_train_stuff_json = None
    coco_val_instances_json = os.path.join(COCO_DIR, 'publaynet/val.json')
    # coco_val_stuff_json = os.path.join(COCO_DIR, 'annotations/stuff_val2017.json')
    coco_val_stuff_json = None
    ...
    train_dset = PublaynetSceneGraphDataset(**dset_kwargs)
    ...
    val_dset = PublaynetSceneGraphDataset(**dset_kwargs)
